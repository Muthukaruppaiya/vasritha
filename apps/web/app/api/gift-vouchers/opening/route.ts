...
function emptyVoucher(status = 200) {
...
export async function GET() {
  try {
    ...
    console.error("[gift-vouchers/opening]", error);
    // Never break the storefront when DB/env is missing or schema is behind.
    return emptyVoucher();
  }
}
