...
export default function AdminCmsPage() {
  ...
  return (
    <>
      <AdminPageHeader
        title="CMS"
        description="Manage storefront banners, pages, menus and home sections."
      />
      ...
      {tab === "banners" && (
        <>
          <AdminPanel title="Add banner">
            <form className="admin-form-grid" onSubmit={createBanner}>
              <label>
                <span>Title</span>
                <input
      ...
      {tab === "pages" && (
        <>
          <AdminPanel title="Create / update page">
            <form className="admin-form-grid" onSubmit={createPage}>
              <label>
                <span>Slug</span>
                <input
                  required
              ...
              <label>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setPageForm((f) => ({ ...f, is_published: e.target.value === "1" }))
                  }
                >
      ...
      {tab === "sections" && (
        <>
          <AdminPanel title="Add home section">
            <form className="admin-form-grid" onSubmit={createSection}>
              <label>
                <span>Type</span>
                <input
                  required
